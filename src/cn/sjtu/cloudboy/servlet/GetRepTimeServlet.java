...
public class GetRepTimeServlet extends HttpServlet {
	 ...
	 protected void doGet(HttpServletRequest request,HttpServletResponse response)
	  ...
	  System.out.println("Get Response History");
	  ...
	  Queue<Double> queue = ResponseStore.getInstance().getResponseHistory();
	  System.out.println("responseQueue = " + queue);
	  if(queue.size() > 0) {
		  json = "";
		  int i = 0;
		  for (Double d : queue) {
