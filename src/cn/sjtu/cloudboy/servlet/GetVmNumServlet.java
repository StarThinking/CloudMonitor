...
public class GetVmNumServlet extends HttpServlet {
	 ...
	 protected void doGet(HttpServletRequest request,HttpServletResponse response)
	  ...
	  System.out.println("Get VmNum History");
	  ...
	  Queue<Integer> queue = AnalysisManager.getInstance().getVmNumHistory();
	  System.out.println("vmNumqueue = " + queue);
	  if(queue.size() > 0) {
		  json = "";
		  int i = 0;
		  for (Integer d : queue) {
