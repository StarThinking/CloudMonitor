...
import cn.sjtu.cloudboy.manager.StopCloud;

//import cn.sjtu.cloudboy.manager.StartCloud;

public class StopVmServlet extends HttpServlet {
	 ...
	 protected void doGet(HttpServletRequest request,HttpServletResponse response)
	  ...
	  System.out.println("StopCloud VMs and Apps");
