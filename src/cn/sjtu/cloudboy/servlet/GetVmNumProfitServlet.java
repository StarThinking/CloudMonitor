...
public class GetVmNumProfitServlet extends HttpServlet {
	 ...
	 protected void doGet(HttpServletRequest request,HttpServletResponse response)
	  ...
	  System.out.println("getVmProfitQueue");
	  ...
	  Queue<Double> queue = AnalysisManager.getInstance().getVmProfitQueue();
	  //Queue<Double> queue = new LinkedList<Double>();
	 // queue.add(1.1);
	  //queue.add(2.2);
	  System.out.println("getVmProfitQueue = " + queue);
